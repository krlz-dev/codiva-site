  ...
  architecture: {
    ...
    pipeline: {
      ...
      nodes: [
        ...
        { name: 'Cola / stream', sub: 'Kafka · SQS' },
        { name: 'Workers', sub: 'stateless ×N', scale: true },
        { name: 'Almacén', sub: 'S3 · base de datos' },
    ...
    quality: {
      ...
      tech: [
        ...
        { problem: 'Eventos y streaming', tool: 'Kafka / Kinesis' },
        { problem: 'Archivos y objetos', tool: 'S3' },
      ],
      creditPre: 'Lectura recomendada',
    ...
    stack: {
      title: 'Un ejemplo real de stack',
      lead: 'Así se ve una arquitectura típica que operamos: contenedores sin estado que escalan solos, con datos y caché gestionados. Empaquetamos con Docker y desplegamos en Kubernetes o en AWS ECS.',
      tiers: [
        { name: 'Balanceador / CDN', sub: 'entrada + TLS' },
        { name: 'Cómputo · pods / tasks', sub: 'stateless · autoescala', scale: true },
        { name: 'Datos', sub: 'RDS (PostgreSQL) + Redis', split: ['RDS · PostgreSQL', 'Redis · caché'] },
      ],
      chips: ['Docker', 'Kubernetes', 'AWS ECS', 'RDS', 'Redis', 'HPA / Auto Scaling'],
      note: 'Las réplicas suben y bajan solas según el tráfico (HPA en Kubernetes, Auto Scaling en ECS). Pagas por lo que usas y absorbes los picos sin intervención manual.',
    },
    security: {

...
export default {
  ...
  lena: {
    ...
    fields: {
      ...
      problem: { label: '¿Qué necesitas resolver?', placeholder: 'Cuéntanos tu problema u objetivo…' },
      timeline: { label: 'Plazo', placeholder: 'Ej: 2 meses' },
      budget: { label: 'Presupuesto', placeholder: 'Ej: CLP 10.000.000' },
      file: { label: 'Adjuntar PDF (opcional, máx. 5 MB)' },
    },
    fileChoose: 'Elegir PDF',
    confirm: 'Confirmo que esta es una consulta y no un pedido confirmado.',
    ...
    errors: {
      ...
      confirm: 'Marca la casilla para confirmar el envío',

...
export default {
  ...
  lena: {
    launcherLabel: 'Habla con Lena',
    openLabel: 'Habla con Lena',
    title: 'Lena — asistente de codiva',
    closeLabel: 'Cerrar',
    greeting: 'Hola, soy Lena 👋, la asistente de codiva. ¿En qué puedo ayudarte?',
    introNote: 'Solo guardo tus datos si confirmas el envío.',
    ...
    prompts: {
      ...
      problem: 'Cuéntame, ¿qué necesitas resolver?',
    ...
    summary: {
      ...
      budget: 'Presupuesto',
      file: 'Adjunto',
      ask: '¿Confirmo y envío tu consulta?',
    },
    errors: {

  ...
  architecture: {
    ...
    pipeline: {
      ...
      nodes: [
        ...
        { name: 'Queue / stream', sub: 'Kafka · SQS' },
        { name: 'Workers', sub: 'stateless ×N', scale: true },
        { name: 'Storage', sub: 'S3 · database' },
    ...
    quality: {
      ...
      tech: [
        ...
        { problem: 'Events and streaming', tool: 'Kafka / Kinesis' },
        { problem: 'Files and objects', tool: 'S3' },
      ],
      creditPre: 'Recommended reading',
    ...
    stack: {
      title: 'A real-world stack example',
      lead: 'This is what a typical architecture we operate looks like: stateless containers that scale themselves, with managed data and cache. We package with Docker and deploy on Kubernetes or AWS ECS.',
      tiers: [
        { name: 'Load balancer / CDN', sub: 'entry + TLS' },
        { name: 'Compute · pods / tasks', sub: 'stateless · autoscaling', scale: true },
        { name: 'Data', sub: 'RDS (PostgreSQL) + Redis', split: ['RDS · PostgreSQL', 'Redis · cache'] },
      ],
      chips: ['Docker', 'Kubernetes', 'AWS ECS', 'RDS', 'Redis', 'HPA / Auto Scaling'],
      note: 'Replicas scale up and down on their own with traffic (HPA on Kubernetes, Auto Scaling on ECS). You pay for what you use and absorb spikes with no manual work.',
    },
    security: {

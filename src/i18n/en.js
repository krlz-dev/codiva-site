...
export default {
  ...
  lena: {
    ...
    closeLabel: 'Close',
    greeting: "Hi, I'm Lena 👋, codiva's assistant. How can I help?",
    introNote: 'I only store your details if you confirm the submission.',
    ...
    prompts: {
      ...
      problem: 'Tell me, what do you need to solve?',
      timeline: 'When do you need it?',
      budget: 'Do you have an estimated budget?',
      file: 'Would you like to attach a PDF (max 5 MB)?',
    },
    fileYes: 'Yes, attach',
    fileNo: 'No, thanks',
    fileAttached: 'Attached',
    confirmYes: 'Confirm and send',
    confirmNo: 'Fix something',
    summary: {
      title: 'Perfect, here is a summary:',
      service: 'Service',
      name: 'Name',
      email: 'Email',
      phone: 'Phone',
      ...
      budget: 'Budget',
      file: 'Attachment',
      ask: 'Shall I confirm and send your inquiry?',
    },
    errors: {
      ...
      problem: 'Tell me a bit more (at least 5 characters)',

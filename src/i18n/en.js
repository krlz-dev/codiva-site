...
export default {
  ...
  lena: {
    ...
    title: 'Contact us',
    closeLabel: 'Close',
    greeting: "Hi 👋, we're codiva. Tell us what you need and we'll get back to you shortly.",
    introNote: 'We only store your details if you confirm the submission.',
    ...
    summary: {
      ...
      budget: 'Budget',
      file: 'Attachment',
      ask: 'Shall we send your inquiry?',
    },
    errors: {
